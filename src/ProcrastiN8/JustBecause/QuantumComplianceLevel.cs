...
public enum QuantumComplianceLevel
{
    None,               // No compliance. Not even trying.
    Entanglish,         // Sounds quantum. Isn’t.
    Copenhagen,         // Observation matters, but only to make things worse.
